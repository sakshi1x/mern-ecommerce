import { FormHelperText, Stack, TextField, Typography, Box, useTheme, useMediaQuery, LinearProgress } from '@mui/material'
    ...
    <Stack width={'100vw'} height={'100vh'} flexDirection={'row'} sx={{ overflowY: "hidden" }}>
      ...
      <Stack flex={1} justifyContent={'center'} alignItems={'center'}>
        ...
        <Stack flexDirection={'row'} justifyContent={'center'} alignItems={'center'}>
          <Stack rowGap={'.4rem'}>
            <Typography variant='h2' sx={{ wordBreak: "break-word" }} fontWeight={600}>E-Ecommerce</Typography>
        ...
        <Stack mt={4} spacing={2} width={is480 ? "95vw" : '28rem'} component={'form'} noValidate onSubmit={handleSubmit(handleSignup)}>
          ...
          <MotionConfig whileHover={{ y: -5 }}>
            ...
            <Box mt={1} width="100%">
              ...
              />
              <Typography mt={0.5} variant="body2" color={passwordStrength < 2 ? "red" : passwordStrength < 4 ? "orange" : "green"}>
